...
describe 'ManagementApi' do
  before(:all) do
    ...
    TalonOne.configure do |config|
      ...
      config.api_key['Authorization'] = ENV['MAPI_KEY']
  ...
  describe 'add_loyalty_points test' do
    it 'should work' do
      loyalty_program_id = '1' # String | The identifier for the loyalty program.
      integration_id = 'rb_test_profile' # String | The identifier of the profile.
      body = TalonOne::AddLoyaltyPoints.new(
        name: 'adding points tests',
        points: 42.67,
        validity_duration: '7D',
        # response_content: [
        #  'customerProfile'
        # ]
      )
  ...
  describe 'get_application test' do
    it 'should work' do
      ...
      result = @api_instance.get_application(1)
