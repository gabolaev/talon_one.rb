...
describe 'IntegrationApi' do
  before(:all) do
    ...
    TalonOne.configure do |config|
      ...
      config.api_key['Authorization'] = ENV['IAPI_KEY']
  ...
  describe 'get_customer_session test' do
    it 'should work' do
      result = @api_instance.get_customer_session('test_session_id')
      pp result
    end
  end
  ...
  describe 'reopen_customer_session test' do
    it 'should work' do
      session_integration_id = 'rb_test_session_2' # String | The integration identifier of the session

      begin
        # Create/update a customer session using `update_customer_session_v2` function
        result = @api_instance.reopen_customer_session(session_integration_id)
  ...
  describe 'update_customer_profile_v2 test' do
    it 'should work' do
      profile_integration_id = 'rb_test_profile'
      profile_request = TalonOne::CustomerProfileIntegrationRequestV2.new(
        attributes: {
          Name: 'Testing Ruby'
        },
        # response_content: [
      ...
      # opts = {
      #   run_rule_engine: true, # Boolean | Indicates whether to run the rule engine. Setting this property to `false` improves response times.
      #   dry: false # Boolean | Indicates whether to persist the changes. Changes are ignored when `dry=true`. Only used when `runRuleEngine` is set to `true`. 
      # }
      
      result = @api_instance.update_customer_profile_v2(profile_integration_id, profile_request)
      pp result
    end
  end
  ...
  describe 'update_customer_session_v2 test' do
    it 'should work' do
      session_integration_id = 'rb_test_session' # String | The integration identifier of the session
      ...
      begin
        # Create/update a customer session using `update_customer_session_v2` function
        result = @api_instance.update_customer_session_v2(session_integration_id, integration_request)
